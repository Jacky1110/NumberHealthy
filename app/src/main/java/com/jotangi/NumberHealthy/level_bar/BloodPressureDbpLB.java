...
public class BloodPressureDbpLB extends View {

    private String TAG = getClass().getSimpleName() + "(TAG)";

    private final int[] levelValues = {60, 80, 90, 100, 110};
    ...
    public BloodPressureDbpLB(Context context) {
        super(context);
        init();
    }


    public BloodPressureDbpLB(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public BloodPressureDbpLB(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    public BloodPressureDbpLB(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
